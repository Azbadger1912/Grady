document.addEventListener('DOMContentLoaded', function() {
    selec_vent('div_agd_cur', 'btn_agd_cur');
});

async function fetchData() {
    try {
        const response = await fetch('/agenda_conse_data');
        if (!response.ok) {
...
document.addEventListener("DOMContentLoaded", function() {
    fetch('/user_data')
        ...
        .then(data => {
            const consejeria = data.consejeria;

            const conse = document.getElementById('consj');
            conse.textContent = consejeria.toUpperCase();
        })
...
function selec_vent(cont, bot){
    ...
    var cont_1 = document.getElementById('div_agd_cur');
    var cont_2 = document.getElementById('div_prom_cur');
    var cont_3 = document.getElementById('div_lib_cur');
    var cont_4 = document.getElementById('div_hab_act');
    var boton = document.getElementById(bot);
    var bot_1 = document.getElementById('btn_agd_cur');
    var bot_2 = document.getElementById('btn_prom_cur');
    var bot_3 = document.getElementById('btn_lib_cur');
    var bot_4 = document.getElementById('btn_hab_act');
